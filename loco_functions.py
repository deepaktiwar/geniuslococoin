...
def main_play_loop(country_abbrev, national_number, profile_token):
    ...
    for i in range(10):
        ...
        for q in range(total_questions):
            ...
            status_dict['question'] = text
            yield status_dict

            coins=json_response['data']['coins']
            status_dict['coins']=coins
            yield status_dict
        ...
        # if json_response['total_correct_answers']:
        #     status_dict['total_correct_answers'] += 1
        #     yield status_dict
        
        # if json_response['text']:
        #     status_dict['question']
        #     yield status_dict
